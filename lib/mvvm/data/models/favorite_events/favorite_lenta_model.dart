...
class FavoriteLentaModel {
  ...
  factory FavoriteLentaModel.fromJson(Map<String, dynamic> json) =>
      FavoriteLentaModel(
...
class ResLentaFavoriteModel {
  ...
  factory ResLentaFavoriteModel.fromJson(Map<String, dynamic> json) =>
      ResLentaFavoriteModel(
        favoriteList: List<FavoriteEventModel>.from(json['FavoriteList']
            .map((property) => FavoriteEventModel.fromJson(property))),
      );
}
